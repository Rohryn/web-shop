...
class GZipServletResponseWrapper extends HttpServletResponseWrapper {
    ...
    public void flushBuffer() throws IOException {
        ...
        IOException gzipStreamException = null;
        try {
            if (this.gzipOutputStream != null) {
                this.gzipOutputStream.flush();
            }
        } catch (IOException e) {
            gzipStreamException = e;
        }
        IOException outputStreamException = null;
        try {
            super.flushBuffer();
        } catch (IOException e) {
            outputStreamException = e;
        }
        if (gzipStreamException != null) throw gzipStreamException;
        if (outputStreamException != null) throw outputStreamException;
    }
